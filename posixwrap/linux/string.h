...
void    *memcpy(void *restrict a, const void *restrict b, size_t c);
...
size_t   strxfrm_l(char *restrict a, const char *restrict b, size_t c, locale_t d);
