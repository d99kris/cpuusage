...
int   pthread_barrier_init(pthread_barrier_t *restrict a, const pthread_barrierattr_t *restrict b, unsigned c);
int   pthread_barrier_wait(pthread_barrier_t *a);
int   pthread_barrierattr_destroy(pthread_barrierattr_t *a);
int   pthread_barrierattr_getpshared(const pthread_barrierattr_t *restrict a, int *restrict b);
int   pthread_barrierattr_init(pthread_barrierattr_t *a);
int   pthread_barrierattr_setpshared(pthread_barrierattr_t *a, int b);
...
int   pthread_condattr_getclock(const pthread_condattr_t *restrict a, clockid_t *restrict b);
...
int   pthread_create(pthread_t *restrict a, const pthread_attr_t *restrict b, void *(*c)(void*), void *restrict d);
...
int   pthread_mutex_timedlock(pthread_mutex_t *restrict a, const struct timespec *restrict b);
...
int   pthread_mutexattr_getrobust(const pthread_mutexattr_t *restrict a, int *restrict b);
...
int   pthread_mutexattr_setrobust(pthread_mutexattr_t *a, int b);
...
int   pthread_rwlock_timedrdlock(pthread_rwlock_t *restrict a, const struct timespec *restrict b);
int   pthread_rwlock_timedwrlock(pthread_rwlock_t *restrict a, const struct timespec *restrict b);
...
int   pthread_setschedprio(pthread_t a, int b);
